  ...
  perChain: [
    ...
    },
    {
      ...
      items: [
        ...
        { ercCode: 23, token: process.env.NFT15_OP_Sepolia as `0x${string}`, id: 11n, amount: 100n },
      ],
    },
    {
      chain: 'baseSepolia',
      ...
      items: [
        { ercCode: 20, token: process.env.USDT_Base_Sepolia as `0x${string}`, id: 0n, amount: 300n * 10n ** 6n },
        { ercCode: 21, token: process.env.NFT21_Base_Sepolia as `0x${string}`, id: 11n, amount: 1n },
      ],
    },
  ],
};
